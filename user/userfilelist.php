    ...
    <div class="container" style="margin-top: 50px;">
        <div class="row">
            ...
            <div class="col-md-3">
                ...
                <img src="../img/filePic.jpg" class="card-img-top" style="height: 250px; width: 271px;">
                    <div class="card-body">
                        <h5 class="card-title" style = "display:flex; justify-content:center;"><?php echo $title; ?></h5>
