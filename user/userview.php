                ...
                <div class="col-md-6">
                    ...
                    <div class="sec2">
                                ...
                                <input type="hidden" name="type_payment" value="<?php echo $property['stype']; ?>">
                                    ...
                                    <input type="submit" class="btn btn-success" style="width: 110px; margin-top: 5px;" value = "BUY">
                                </form>
                                <a href="buiding_reports.php?name='<?php echo $property['title']; ?>'" class="btn btn-danger" style="margin-left: 550px; margin-top: 10px;"> Report
