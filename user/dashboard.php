...
<body>
      ...
      <div class="main">
          ...
          <div class="section1">
                    ...
                    <div class="box">
                        <a href = "dashboardlink/homepage.php">
                                <div class="title"> 
                                    Home
                                </div>
                                <div class="logo">
          ...
          <div class="section2">
                    ...
                    <div class="box">
                        <a href="resources.php">
                                ...
                                <div class="logo">
                                  <svg xmlns="http://www.w3.org/2000/svg" width="40" height="40" fill="rgb(114,111,111)" class="bi bi-file-earmark-ruled" viewBox="0 0 16 16">
